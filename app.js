...
const TRANSLATIONS = {
    "zh-TW": {
        ...
        "app_version": "App 版本: v27 (支援尼泊爾文與簡體中文)",
    ...
    "zh-CN": {
        "app_title": "FlushFinder - 附近厕所即时搜索",
        "app_subtitle": "寻找身边最舒适的方便之处",
        "locating": "正在定位您的位置...",
        "search_placeholder": "输入地址或地标手动定位...",
        "locate": "定位",
        "location_tip": "提示：拖动地图上的蓝色定位点，或在任一处双击地图即可手动修正位置。",
        "filters_title": "设施与条件筛选",
        "filter_all": "全部",
        "filter_accessible": "无障碍",
        "filter_baby": "親子/母婴",
        "filter_free": "免费使用",
        "filter_rating": "4星以上",
        "results_title": "附近厕所",
        "sort_by_distance": "依距离排序",
        "locating_and_loading": "正在定位并加载周边厕所...",
        "settings_title": "数据来源设定",
        "settings_source_desc": "选择要加载的厕所数据来源：",
        "source_osm": "OpenStreetMap (全球即时免金钥)",
        "source_moenv": "环境部 Open Data (已配置云端金钥)",
        "source_local": "本地离线数据 (台北大安区)",
        "settings_lang_desc": "选择介面语言 (Language)：",
        "settings_font_desc": "设定介面与地图字体大小：",
        "font_sm": "小 (Small)",
        "font_md": "中 (Medium - 默认)",
        "font_lg": "大 (Large)",
        "moenv_key_tip": "提示：已为您设定好云端金钥，直接选择即可使用。若您有自订金钥，可在下方输入并储存以进行覆盖：",
        "moenv_key_placeholder": "请输入自订 MOENV API Key",
        "save": "储存",
        "current_source_label": "目前数据来源：",
        "force_clear_cache": "强制更新缓存",
        "close_menu": "关闭选单",
        "open_menu": "开启选单",
        "my_location": "我的位置",
        "toggle_theme": "切换深浅色地图",
        "app_version": "App 版本: v27 (支援尼泊尔文与简体中文)",
        
        "gps_locating": "正在取得 GPS 精确定位...",
        "gps_failed": "无法取得 GPS 精确定位，系统已为您使用默认或先前的位置。您可以透过搜索栏、拖动蓝色定位点或在地图上双击，手动修正位置。",
        "my_location_tooltip": "我目前的位置 (可拖动修正)",
        "locating_places": "正在读取附近地标...",
        "input_empty_error": "请输入要搜索的地址或地标名称！",
        "searching": "搜索中...",
        "search_failed_no_results": "找不到关于“{query}”的地点。请尝试输入更具体的路名、大楼或地标名称。",
        "search_error": "搜索地点失败，请检查网路连线或稍后再试。",
        "no_results": "没有符合筛选条件的公厕",
        "distance_straight": "直线 {dist} 米",
        "distance_km": "直线 {dist} 公里",
        "walk_time": "步行约 {mins} 分钟",
        "status_available": "尚有空位",
        "status_busy": "使用中",
        "status_closed": "已关闭",
        "drawer_planning_route": "正在规划步行路径...",
        "drawer_accessible": "无障碍洗手间",
        "drawer_baby": "親子/母婴设备",
        "drawer_free": "免费使用",
        "drawer_start_nav": "开始导航",
        "drawer_report_error": "错误回报",
        "drawer_address_loading": "详细地址加载中...",
        "report_success_toast": "感谢回报！我们将尽快查证关于“{name}”的状况。",
        "save_key_success": "成功储存 API Key！将为您加载即时环境部开放数据。",
        "clear_key_success": "已清除 API Key，为您恢复本地离线数据。",
        "loading_new_data": "正在加载最新数据...",
        "switching_source": "正在切换数据来源...",
        "clear_cache_confirm": "是否要强制清除缓存并重新加载应用程式？",
        "data_fallback_msg": "无法自环境部 API 读取数据，尝试切换为本地离线数据：",
        "data_fallback_alert": "加载环境部数据失败！\n\n原因：{reason}\n\n系统已为您自动切换为“本地离线数据”。",
        "osm_failed_alert": "加载 OpenStreetMap 数据失败，系统正自动切换为第二顺位“环境部 Open Data”。\n\n详细原因：{reason}",
        "osm_fallback_local_alert": "加载 OpenStreetMap 與環境部數據皆失敗，已为您自动切换为本地离线数据。\n\n详细原因：{reason}",
        "osm_planning_route": "正在规划路径...",
        "osm_actual_route": "实际路程 <strong>{dist}</strong> ({time})",
        "osm_actual_walk_time": "实际步行约 {mins} 分钟",
        "osm_route_fallback": "预估路程 {dist} (步行约 {mins} 分钟)",
        "address_resolved_failed": "请参考地图标记定位",
        "address_resolved_user": "已定位到您的位置",
        "source_label_osm": "OpenStreetMap (即时)",
        "source_label_moenv_custom": "环境部 Open Data (自订金钥)",
        "source_label_moenv_cloud": "环境部 Open Data (云端金钥)",
        "source_label_local_fallback": "本地离线数据 (备援)",
        "source_label_local": "本地离线数据",
        ...
        "moenv_desc": "管理单位: {admin}。公厕类别: {type2}。公厕评级: {grade}。",
        "osm_desc": "OSM ID: {id}。营运管理: {operator}。是否有无障碍: {wheelchair}。"
    },
    "en": {
        ...
        "app_version": "App Version: v27 (Nepali & Simplified Chinese support)",
    ...
    "ja": {
        ...
        "app_version": "アプリバージョン: v27 (ネパール語・簡体字中国語対応)",
    ...
    "sv": {
        ...
        "app_version": "App-version: v27 (nepalesiskt & förenklat kinesiskt stöd)",
    ...
    "ne": {
        ...
        "app_version": "एप संस्करण: v27 (नेपाली र सरलीकृत चिनियाँ समर्थन)",
...
function getInitialLanguage() {
    ...
    if (systemLang.startsWith("zh")) {
        if (systemLang === "zh-CN" || systemLang === "zh-SG" || systemLang.toLowerCase().includes("hans")) {
            return "zh-CN";
        }
        return "zh-TW";
    }
